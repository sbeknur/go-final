...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://postgresql:zMoVObylhKti6q8cpiaXlLPlVdesRrke@dpg-cfs3d89gp3jt6tihehpg-a.oregon-postgres.render.com/go_final_lwbr", "PostgreSQL DSN")
